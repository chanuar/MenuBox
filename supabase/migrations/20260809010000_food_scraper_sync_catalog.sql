-- Atomic, service-role-only catalog publishing for the standalone scraper.
...
begin
  ...
  insert into food.restaurants (
    scraper_key, name, description, image_url, source_url,
...
revoke all on function public.food_scraper_sync_catalog(jsonb, jsonb, boolean, boolean) from public;
grant execute on function public.food_scraper_sync_catalog(jsonb, jsonb, boolean, boolean) to service_role;
